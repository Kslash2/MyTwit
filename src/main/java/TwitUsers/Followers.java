...
public class Followers extends Friends {
    ...
    /**
     * Implements abstract method createIDs, with "TwitUsers.Followers" IDs
     * @throws TwitterException
     */
    protected void createIDs() throws TwitterException {
        System.out.println("Creating followers IDs...");
        long cursor =-1L;
        IDs ids;
        do {
            ids = super.getTwitter().getFollowersIDs(super.getUsername(),cursor);
